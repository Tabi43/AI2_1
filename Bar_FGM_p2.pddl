...
(:init
    ...
    (=(distance_location t4 t1) 1) (=(distance_location t4 t2) 1)
    ...
    (=(square_2_clean t1) 1) (=(square_2_clean t2) 0) (=(square_2_clean t4) 0) (=(square_2_clean t3) 0)   
)
...
(:goal (and 
        ...
        (not (give_biscuit d3)) (not (give_biscuit d4))
        (=(square_2_clean t1) 0) (=(square_2_clean t3) 0) 
