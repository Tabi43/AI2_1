...
(:init 
    ...
    (=(dim_table t1) 1) (=(dim_table t2) 1) (=(dim_table t3) 2) (=(dim_table t4) 1)
    ...
    (= (biscuit_on_tray) 0)
    (= (time_2_drink d1) 0) (= (time_2_drink d2) 0) 
    (= (time_2_prep d1) 0) (= (time_2_prep d2) 0)
    
    ;problem specification 
    (order d1) (order d2)
    (assigned ambrogio d1) (assigned ambrogio d2)
    (= (drinks_assigned t2) 2)
    (=(square_2_clean t3) 2) (=(square_2_clean t4) 1)
    (=(square_2_clean t1) 0) (=(square_2_clean t2) 0)
)

(:goal (and 
        (at_location t2 d1) (at_location t2 d2)
        (= (drinks_assigned t2) 0) 
        (not (give_biscuit d1)) (not (give_biscuit d2))
        (=(square_2_clean t3) 0) (=(square_2_clean t4) 0)
        (=(square_2_clean t2) 0)
